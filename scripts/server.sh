...
# 2023 11 18
function robo_server_ssh_check() { robo_server_ssh robo_system_wtf; }

function robo_server_ssh_update() {
    _robo_server_ssh_update_repo;
    _robo_server_ssh_update_system;
}
function _robo_server_ssh_update_repo() {
    robo_server_ssh "robo_repo_update" tabs;
}
function _robo_server_ssh_update_system() {
    robo_server_ssh "robo_system_update" tabs;
}

function _robo_server_ssh_install() {
    robo_server_ssh "robo_system_install" tabs;
}

function _robo_server_ssh_reboot() {
    robo_server_ssh "sudo reboot" tabs;
}
function _robo_server_ssh_poweroff() {
    robo_server_ssh "sudo poweroff" tabs;
}

function _robo_server_ssh_pololu() {
    robo_server_ssh "pololu_repo_make" tabs;
}
function _robo_server_ssh_robolib() {
    robo_server_ssh "robolib_repo_make" tabs;
}
